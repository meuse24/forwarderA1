...
class MainActivity : ComponentActivity() {
                ...
                when {
                    !isFullyInitialized || isLoading -> {
                        ...
                        if (prefsAvailable && loggerAvailable && permissionAvailable) {
                            ...
                            LoadingScreen(error = "Initialisierung unvollständig - Komponenten nicht verfügbar")
                        }
                    }
                }
            }
    ...
    private fun ExitDialog(
        ...
        var keepForwarding by remember { mutableStateOf(AppContainer.requirePrefsManager().getKeepForwardingOnExit()) }
...
// Speichere den Orientierungszustand
    ...
    fun PinDialog(
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    if (pin == AppContainer.requirePrefsManager().getLogPIN()) {
                        onPinCorrect()
                    } else {
                        error = true
                    }
    ...
    fun ChangePinDialog(
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    when {
                        currentPin != AppContainer.requirePrefsManager().getLogPIN() -> {
